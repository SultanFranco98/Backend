...
urlpatterns = [
    ...
    path('articles/edit/<int:pk>', ArticleViewSet.as_view({'put': 'update'})),
    path('articles/delete/<int:pk>', ArticleViewSet.as_view({'delete': 'destroy'})),
    path('articles/create', ArticleViewSet.as_view({'post': 'create'})),

    path('votes/create/<int:pk>', VoteViewSet.as_view({'post': 'create'})),
    path('votes/edit/<int:pk>', VoteViewSet.as_view({'put': 'update'})),
    path('votes/delete/<int:pk>', VoteViewSet.as_view({'delete': 'destroy'})),
